		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<table align="right">
							<tr>
							<td>
								<a class="" href="<?php echo site_url('jabatan/create/'.$this->uri->segment(3)); ?>"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> Tambah Jabatan</a>
							</td>
							...
							<table class="table table-hover">
								...
								<?php foreach ($jabatan_list as $key) { ?>
									<tr>
										...
										<td>
										<a class="" href="<?php echo site_url('jabatan/update/'.$this->uri->segment(3)); ?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Edit Jabatan</a>
										</td>
									</tr>
								<?php } ?>
								</tbody>
